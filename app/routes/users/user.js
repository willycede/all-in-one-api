...
router.post('/change-password', verifyToken, assertSelfUser, authRateLimit, userController.changePassword);
router.get('/:id', userController.getUserById);
router.post("/update", verifyToken, assertSelfUser, userController.updateUserInfo);
